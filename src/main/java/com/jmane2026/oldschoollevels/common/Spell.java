...
public enum Spell {
    AIR_BLAST("Air Blast", 1, List.of(new SpellCost(ModItems.AIR_SIGIL, 1)), "air_blast", 3.0f, 0),
    ...
    WATER_BLAST("Water Blast", 40, List.of(new SpellCost(ModItems.WATER_SIGIL, 1), new SpellCost(ModItems.AIR_SIGIL, 1)), "water_blast", 7.0f, 0),
    ...
    FIRE_BLAST("Fire Blast", 80, List.of(new SpellCost(ModItems.FIRE_SIGIL, 1), new SpellCost(ModItems.AIR_SIGIL, 1)), "fire_blast", 12.0f, 0),
